...
public class InputService {
	...
	public GitlabAuthEnum getAuthType() {
		System.out.println("请输入Gitlab连接类型，1-TOKEN认证，其他字符为账号密码认证：");
	...
	public String[] getAuthParam() {
		System.out.println("请输入认证参数，账号密码使用英文逗号分隔：");
	...
	public String getNamespace() {
		System.out.println("请输入命名空间完整名称：");
		return scanner.nextLine();
	}
	...
	public String getProjectName() {
		System.out.println("请输入项目名称筛选条件：");
		return scanner.nextLine();
	}
	...
	public UrlToRepoEnum getDownloadUrlType() {
		System.out.println("请输入下载方式，SSH，其他字符为HTTP链接下载：");
